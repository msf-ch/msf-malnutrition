...
public class HTMLFormPatientActivity extends Activity {
	private WebView wv;
	
	private Patient mySelectedPatient;
	
	private static String URLForm = "file:///android_asset/cholera/html/formpages_patient.html";
	...
	private void initializeWebView() {
		...
		final ProgressDialog dialog = new ProgressDialog(HTMLFormPatientActivity.this);
		...
		wv.addJavascriptInterface(new HtmlFormChildInterface(this, mySelectedPatient), "MSF");
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
	    if (keyCode == KeyEvent.KEYCODE_MENU) {
	    	AlertDialog.Builder adb = new AlertDialog.Builder(HTMLFormPatientActivity.this);
            ...
            adb.setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {  
                    public void onClick(DialogInterface dialog, int whichButton)
                        {
                    		HTMLFormPatientActivity.this.finish();
                        }
                }); 
