...
public class HTMLFormChildActivity extends Activity{
	private WebView wv;
	
	private static String URLForm = "file:///android_asset/child_malnutrition/html/formpages_child.html";
...
//		wv.addJavascriptInterface(new ChildInterface(new MalnutritionWorkflowManager(null)), "MSF");
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
	    ...
	    if (keyCode == KeyEvent.KEYCODE_MENU) {
	    	AlertDialog.Builder adb = new AlertDialog.Builder(HTMLFormChildActivity.this);
            ...
            adb.setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {  
                    public void onClick(DialogInterface dialog, int whichButton)
                        {
                    		HTMLFormChildActivity.this.finish();
                        }
                }); 
