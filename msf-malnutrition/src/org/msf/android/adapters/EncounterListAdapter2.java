...
public class EncounterListAdapter2 extends CursorAdapter {
	...
	public EncounterListAdapter2(Context context, Cursor c, boolean autoRequery, ClinicAdapter ca) {
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		...
		View v = vi.inflate(R.layout.encounter_list_item2, null);
